...
<div class="pub-row">
  ...
  <div class="col-sm-9" style="position: relative;padding-right: 15px;padding-left: 20px;">
      <div class="title"><a href="">Pyramidal-Graded Response for Large Language Model on Youth Safety</a></div>
      <div class="author"><strong>Mingni Tang</strong>, Zuchao Li, Lefei Zhang, Ping Wang</div>
      <div class="periodical"><em></em>
      </div>
    <div class="links">
      <a href="" class="btn btn-sm z-depth-0" role="button" target="_blank" style="font-size:12px;">PDF</a>
